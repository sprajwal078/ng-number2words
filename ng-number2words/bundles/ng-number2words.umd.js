    ...
    ***************************************************************************** */
    ...
    var ConverterUtil = /** @class */ (function () {
        function ConverterUtil(value, tenthMapping, subHundredMapping, max, decimalNotation, negativeNotation) {
            if (tenthMapping === void 0) {
                tenthMapping = WORD_MAPPING.international.en.tenths;
            }
            if (subHundredMapping === void 0) {
                subHundredMapping = WORD_MAPPING.international.en.subHundreds;
            }
            if (max === void 0) {
                max = (1000 * WordValues.trillion - 1);
            }
            if (decimalNotation === void 0) {
                decimalNotation = 'point';
            }
            if (negativeNotation === void 0) {
    ...
    exports.ToHinduArabicWordsPipe = ToHinduArabicWordsPipe;
